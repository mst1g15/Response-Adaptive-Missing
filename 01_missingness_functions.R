...
handle_missing <- function(y_t, arm_t, p0_t, p1_t, approach, ...){
  ...
  #       approach: "cc" for complete case, and single imputation strategies 
  #                 "single_impute_current", "single_impute_backward" and "impute zero" 
